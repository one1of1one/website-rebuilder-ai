...
privately using contact information published on the
[repository owner's GitHub profile](https://github.com/one1of1one). If no private
contact method is available, open a minimal
[conduct contact request](https://github.com/one1of1one/website-rebuilder-ai/issues/new)
without incident details so a community leader can establish a private channel. Do
not identify involved people or describe the incident publicly.
